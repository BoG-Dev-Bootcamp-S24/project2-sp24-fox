    ...
    return (
        <div class="flex flex-row">
            <div class="flex flex-col items-start w-[280px] h-screen">
                <div class="pt-[20px]">
                    <button class="flex flex-row justify-start items-center hover:bg-red-400 w-[240px] h-[45px] ml-[15px] pl-[15px] rounded-[13px] text-left text-lg">
                ...
                <div class="flex-col fixed bottom-5 h-[60px]">
                    ...
                    <div class="flex flex-row justify-between items-center mt-[5px] mb-[10px]">
                        <div class="flex flex-row justify-center items-center">
                            <div class="flex flex-row justify-center items-center bg-red-500 w-[40px] h-[40px] font-bold text-lg rounded-[50px] ml-[20px] mr-[15px]">
                                L
                            </div>
